...
class TestUserProfileModel(TestCase):
    ...
    def test_profile_creation(self):
        ...
        self.assertEqual(
            profile.research_interests, "Digital Humanities, Urdu Literature"
        )
    ...
    def test_profile_optional_fields(self):
        ...
        minimal_profile = UserProfile.objects.create(
            user=self.user, research_interests="Digital Humanities"
        )
    ...
    def test_profile_preferences_json(self):
        ...
        complex_preferences = {
            "ui": {"language": "en", "theme": "dark", "font_size": "medium"},
    ...
    def test_profile_research_interests_validation(self):
        ...
        profile = UserProfile.objects.create(
            user=self.user, research_interests=long_interests
        )
    ...
    def test_profile_metadata_json(self):
        ...
        profile = UserProfile.objects.create(
            user=self.user, research_interests="Digital Humanities", metadata=metadata
        )
        ...
        self.assertEqual(
            profile.metadata["skills"]["languages"], ["Urdu", "English", "Arabic"]
        )
...
class TestUserProfileIntegration(TestCase):
    ...
    def test_multiple_users_with_profiles(self):
        ...
        for i, profile in enumerate(created_profiles):
            ...
            self.assertEqual(
                profile.research_interests, user_data["research_interests"]
            )
