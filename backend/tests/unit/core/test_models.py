...
class TestAuditLog(TestCase):
    ...
    def test_audit_log_action_choices(self):
        ...
        for action in valid_actions:
            audit_log = AuditLog.objects.create(
                action=action, resource_type="TestModel", resource_id=1, user=self.user
            )
    ...
    def test_audit_log_details_json(self):
        ...
        complex_details = {
            "nested": {"field": "value", "list": [1, 2, 3], "boolean": True},
            "simple": "string",
        }
    ...
    def test_audit_log_changes_default(self):
        ...
        audit_log = AuditLog.objects.create(
            action="view", resource_type="TestModel", resource_id=1, user=self.user
        )
    ...
    def test_audit_log_ordering(self):
        ...
        AuditLog.objects.create(
            action="update", resource_type="TestModel", resource_id=1, user=self.user
        )
